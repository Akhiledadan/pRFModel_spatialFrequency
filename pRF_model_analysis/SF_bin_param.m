function [data,b_xfit,b_upper_plot,b_lower_plot,b_y] = SF_bin_param(x_param,y_param,w,xfit,opt)
...
% define the binning and bootstrapping types
bin_type = opt.binType;
bootType = opt.bootType;
...
if strcmp(bootType,'bin')
    ...
    y_data = y_bin;
    w_data = w_bin;
    B = bootstrp(1000,@(x) localfit(x,x_data,y_data,w_data),(1:numel(x_data))); % 1000 iterations, bootstrap the 20 bins and calculate the slope and intercept for each of the bootstrapped conditions  
