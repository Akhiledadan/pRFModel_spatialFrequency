function NP_Sigma_ecc_2(main_dir,save_results,save_plots,plot_type)

% NP_Sigma_ecc - Plots Sigma vs eccentricity for the pRF fits of different spatial frequencies
%
% Input - modeling results for different SF (3, 6, 12, 18)
%       - ROIs
%       -
...
conditions = {'sf03';'sf06';'sf12';'sf18'};
...
for cond_idx = 1:length(conditions)
    ...
    model_fname =  dir(fullfile(paths.model_path_ind,'*refined_-fFit.mat'));
...
% paths.all_model_path = strcat(paths.orig_path,'/Gray/all/');
...
for roi_idx = 1:num_roi
    ...
    switch plot_type
        ...
        case 'Ecc_Sig'
            ...
            x_param_comp_4 = Cond_model{4,roi_comp}{1}.ecc;% sf18
            ...
            y_param_comp_4 = Cond_model{4,roi_comp}{1}.sigma;
        ...
        case 'Ecc_SurSize_DoGs'
            ...
            x_param_comp_4 = Cond_model{4,roi_comp}{1}.ecc;
            ...
            y_param_comp_4 = Cond_model{4,roi_comp}{1}.DoGs_surroundSize;
        ...
        case 'Pol_Sig'
            ...
            x_param_comp_4 = Cond_model{4,roi_comp}{1}.pol;
        ...
        case 'X_Sig'
            ...
            x_param_comp_4 = Cond_model{4,roi_comp}{1}.x;
        ...
        case 'Y_Sig'
            ...
            x_param_comp_4 = Cond_model{4,roi_comp}{1}.y;
 ...
 %%   
    ...
    plot(x_param_comp_3,y_param_comp_3,'.','color',[1 0.5 0.5],'MarkerSize',10); hold on;   
    plot(x_param_comp_4,y_param_comp_4,'.','color',[0.5 0.5 0.5],'MarkerSize',10); hold on;
...
%%   
    ...
    [param_comp_3_yfit] = NP_fit(x_param_comp_2,y_param_comp_3,Cond_model{3,roi_comp}{1}.varexp,xfit);
    [param_comp_4_yfit] = NP_fit(x_param_comp_2,y_param_comp_4,Cond_model{4,roi_comp}{1}.varexp,xfit);
    ...
    plot(xfit,param_comp_4_yfit','color','k','LineWidth',2); hold on;
    ...
    [param_comp_3_data,param_comp_3_b_xfit,param_comp_3_b_upper,param_comp_3_b_lower] = NP_bin_param(x_param_comp_3,y_param_comp_3,Cond_model{3,roi_comp}{1}.varexp,xfit);
    [param_comp_4_data,param_comp_4_b_xfit,param_comp_4_b_upper,param_comp_4_b_lower] = NP_bin_param(x_param_comp_4,y_param_comp_4,Cond_model{4,roi_comp}{1}.varexp,xfit);
    hold on;  
    ...
    patch([param_comp_4_b_xfit, fliplr(param_comp_4_b_xfit)], [param_comp_4_b_lower', fliplr(param_comp_4_b_upper')], [0.5 0.5 0.5], 'FaceAlpha', 0.5, 'LineStyle','none');
    ...
    errorbar(param_comp_1_data.x,param_comp_1_data.y,param_comp_1_data.ysterr,'ro','MarkerFaceColor','r','MarkerSize',MarkerSize);
    errorbar(param_comp_2_data.x,param_comp_2_data.y,param_comp_1_data.ysterr,'ko','MarkerFaceColor','k','MarkerSize',MarkerSize);
    titleall = sprintf('%s', roi_comp) ;
    title(titleall);
    legend([{data_comp_1},{data_comp_2},{data_comp_3},{data_comp_4}],'Location','northWest');
    ylim(yaxislim);
    xlim(xaxislim);
...
%%    
    ...
    title(titleall);
    hold off;
    set(h.Parent,'XTickLabel',[{data_comp_1},{data_comp_5}]);
