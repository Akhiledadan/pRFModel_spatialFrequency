...
addpath(genpath('/home/roelofzen/Desktop/AFNI_tutorial-master/Scripts'));
...
% Skull strip the anatomy
% system('3dSkullStrip -prefix anatomy_ss.nii.gz -input anatomy.nii.gz');

% Use the deobliqued amplitude anatomy (inplane) file
system('3dAutomask -apply_prefix amplitudeAnatomy_mask.nii.gz amplitudeAnatomy.nii');
...
system('@Align_Centers -base anatomy_ss.nii -dset amplitudeAnatomy_mask_zp.nii.gz -cm');
...
% e.g.: 
system(['3drotate -quintic -clipit -rotate 0.00I -5.00R 0.00A -ashift 9.39S 0.00L -7.03P -prefix ' ...
...
system(['align_epi_anat.py -anat anatomy_ss.nii ' ...
	...
	'-anat_has_skull no ' ...
	'-epi_strip None '...
    '-Allineate_opts -maxrot 3 -maxshf 3']);
