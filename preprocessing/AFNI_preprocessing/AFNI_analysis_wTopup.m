...
setupDirectories_highRes % run in r2agui output folder
...
system('motionCorrect.afni.blip.sh EPI/ TOPUP/ 1 1 1-2-3-4 1-2-3-4 5 -1')
...
% When deoblique-ing the amplitude anatomy to improve coregistration
% system('3dWarp -deoblique -prefix amplitudeAnatomy_deob.nii amplitudeAnatomy.nii')
