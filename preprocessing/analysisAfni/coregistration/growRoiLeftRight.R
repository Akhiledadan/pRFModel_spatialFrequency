...
#setwd('/media/alessiofracasso/storage2/Francesco/V5248/anatomy/results')
#args <- c('outputVolume.nii.gz','/usr/lib/afni/bin','/home/alessiofracasso/Dropbox/analysisAfni/surfaces')
