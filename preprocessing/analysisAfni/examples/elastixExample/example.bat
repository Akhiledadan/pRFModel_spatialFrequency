...
mkdir exampleoutput
elastix -f EPI_zp_clip_ss.nii -m MPRAGE_zp_shft_unif.nii -out exampleoutput -p parameters_Affine.txt -p parameters_BSpline.txt
cp EPI_zp_clip_ss.nii exampleoutput/
